...
Completed UTC: `2026-07-20T21:07:01Z`
...
|---|---|---:|---|---|
| Codex Tribunal | https://github.com/Martin-Hausleitner/tribunal-public | 0 | MIT | `2026-07-20T21:00:07Z` |
| promptfoo | https://github.com/promptfoo/promptfoo | 23,443 | MIT | `2026-07-20T18:15:45Z` |
| Microsoft Agent Framework | https://github.com/microsoft/agent-framework | 12,251 | MIT | `2026-07-20T20:55:39Z` |
...
| Langfuse | https://github.com/langfuse/langfuse | 31,510 | NOASSERTION | `2026-07-20T20:55:18Z` |
| DSPy | https://github.com/stanfordnlp/dspy | 36,259 | MIT | `2026-07-20T15:18:05Z` |
| Phoenix | https://github.com/Arize-ai/phoenix | 10,642 | NOASSERTION | `2026-07-20T21:06:46Z` |
| lm-evaluation-harness | https://github.com/EleutherAI/lm-evaluation-harness | 13,341 | MIT | `2026-07-13T20:18:15Z` |

Compared with the immediately preceding `20:51:06Z` snapshot, only mutable adoption/activity facts changed: promptfoo, Agent Framework, Langfuse, and DSPy each gained one star; Codex Tribunal, Agent Framework, Langfuse, and Phoenix reported newer pushes. Stars remain context and contribute exactly zero rubric points.
...
```text
csv-gate PASS: 11 rows, one crown=Codex Tribunal, score spread=53-85, snapshot=2026-07-20T21:07:01Z
```
